...
module.exports = class extends Event {
	...
	async run() {
		...
		const commands = [
			...
			{
				name: 'happyhour',
				description: 'Provides the Bot Admins the opportunity to enable or disable the happy hour mode!',
				options: [
					{
						name: 'toggle',
						type: 'BOOLEAN',
			...
			{
				name: 'mine',
				description: 'Mine cookies (only works if you own a golden cookie miner)',
				options: [],
			}
		];
	}
